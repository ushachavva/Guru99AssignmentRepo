...
public class NewTestCase6 {
	  private WebDriver driver;
	  private String baseUrl;
	  public String firstName = "USHA";    // These testdata stuff will be placed    
	  public String lastName = "REDDY";  // in a TestData EXCEL file at some stage
	  public String vEmail = "usha123@gmail.com";
	  public String vPW = "password123";
